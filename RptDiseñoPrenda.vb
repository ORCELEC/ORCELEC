...
Public Class RptDiseñoPrenda
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ORCELEC.RptDiseñoPrenda.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptDiseñoPrenda
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptDiseñoPrenda = New RptDiseñoPrenda()
        rpt.Site = Me.Site
        Return rpt
    End Function
