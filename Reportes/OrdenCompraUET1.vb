...
Public Class OrdenCompraUET
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ORCELEC.OrdenCompraUET.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOrdenCompraUET
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OrdenCompraUET = New OrdenCompraUET()
        rpt.Site = Me.Site
        Return rpt
    End Function
