...
Public Class CartaGarantiaFP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ORCELEC.CartaGarantiaFP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCartaGarantiaFP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CartaGarantiaFP = New CartaGarantiaFP()
        rpt.Site = Me.Site
        Return rpt
    End Function
