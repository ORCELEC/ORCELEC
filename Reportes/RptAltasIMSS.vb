...
Public Class RptAltasIMSS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ORCELEC.RptAltasIMSS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NO_FACTURA() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptAltasIMSS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptAltasIMSS = New RptAltasIMSS()
        rpt.Site = Me.Site
        Return rpt
    End Function
