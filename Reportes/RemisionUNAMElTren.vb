...
Public Class RemisionUNAMElTren
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ORCELEC.RemisionUNAMElTren.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRemisionUNAMElTren
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RemisionUNAMElTren = New RemisionUNAMElTren()
        rpt.Site = Me.Site
        Return rpt
    End Function
