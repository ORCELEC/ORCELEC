...
SolicitarCantidadDeImpresiones:
    ...
    Private Sub BtnMuestraRemision_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnMuestraRemision.Click
        ...
        If Cve_Cliente = 556 Or Cve_Cliente = 557 Or Cve_Cliente = 558 Or Cve_Cliente = 559 Or Cve_Cliente = 560 Or Cve_Cliente = 561 _
                            ...
                            Or Cve_Cliente = 678 Or Cve_Cliente = 679 Or Cve_Cliente = 680 Or Cve_Cliente = 681 Or Cve_Cliente = 682 Or Cve_Cliente = 683 _
                            Or Cve_Cliente = 684 Or Cve_Cliente = 685 Or Cve_Cliente = 686 Or Cve_Cliente = 687 Or Cve_Cliente = 688 Or Cve_Cliente = 689 _
                            Or Cve_Cliente = 690 Or Cve_Cliente = 691 Or Cve_Cliente = 692 Then
